                            ...
                            <Card.Body>
                                <Row style={{ fontSize: '0.88rem' }}>
                                    <Col style={{ textAlign: 'left' }}>
                                        ...
                                        <h6><strong>Order Status </strong> &nbsp;<span style={{ padding: '10px' }} className={ order.status === 'Cancel' ? 'badge bg-danger' : order.status === 'Delivered' ? 'badge bg-success' : 'badge bg-warning'}>{order.status === '' ? 'Placed' : order.status}</span> </h6>
                                        <br></br>
                                    ...
                                    <Col style={{ textAlign: 'right' }}>
                                        ...
                                        <br></br>
                                        <Button className="btn btn-warning" style={{ marginTop: '8px' }} onClick={handleShow}>
